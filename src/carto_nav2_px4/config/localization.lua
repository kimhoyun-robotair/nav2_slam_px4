...
options = {
  ...
  map_frame = "map",
  tracking_frame = "x500_rtab_0/base_footprint", -- Ensure imu frame is used as tracking frame
  published_frame = "x500_rtab_0/base_footprint",
  odom_frame = "x500_rtab_0/odom",
